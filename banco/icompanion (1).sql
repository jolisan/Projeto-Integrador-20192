...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 01-Dez-2019 às 18:39
...
(2, '2019-11-30', 2, 'Jogar volei', 'Bater aquele voleizao', 5, 1),
(3, '2019-11-30', 1, 'Reuniao do PI', 'Reunir pra terminar o PI 1', 5, 2),
(4, '2019-11-30', 3, 'Trocar ideia', 'Bater aquele papo', 5, 2),
(5, '2019-11-30', 4, 'Ainda nao sei', 'to pensando', 5, 2),
(6, '2019-11-30', 3, 'Andar de bike', 'Rolezao de bike', 5, 4),
(7, '2019-11-30', 2, 'Bar', 'Tomar uma no bar ', 5, 4),
(8, '2019-11-30', 7, 'Cinema', 'Assistir vingadores ', 5, 3),
(9, '2019-11-30', 16, 'To pensando', 'Ainda n sei', 5, 3),
(10, '2019-11-30', 10, 'Role', 'Dar um role de carro', 5, 3);
