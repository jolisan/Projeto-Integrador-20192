											...
											<div class="kt-widget kt-widget--user-profile-1">
												...
												<div class="kt-widget__body">
													...
													<div class="kt-widget__items">
														<a href="colaborador/painel/" class="kt-widget__item kt-widget__item--active">
															...
															<div class="kt-widget2">
																<div class="kt-widget2__item kt-widget2__item--primary">
																	...
																	<?php
																		...
																		$sql = mysqli_query($conn, "SELECT c.descricao, c.nome_encontro 
																									FROM combinacoes c 
																									INNER JOIN colaborador p ON(c.id_colaborador = p.id_colaborador) 
																									INNER JOIN usuario u ON(p.id_usuario = u.id_usuario) 
																									WHERE c.id_colaborador = (SELECT id_colaborador 
																														FROM colaborador c 
																														INNER JOIN usuario u ON(c.id_usuario = u.id_usuario) 
																														WHERE u.id_usuario = ".$idX."
																									)") or die( 
