...
if(!$_SESSION['usuarioEmail']) {
	...
	$sql = mysqli_query($conn, "SELECT t.telefone, u.id_usuario, t.ddi, t.ddd FROM usuario u LEFT JOIN telefone t ON(u.id_usuario = t.id_usuario) WHERE u.id_usuario = ".$idX."") or die( 
		mysqli_error($sql)
	);
	...
	$sql2 = mysqli_query($conn, "SELECT e.cidade, e.estado, u.id_usuario FROM usuario u LEFT JOIN endereco e ON(u.id_usuario = e.id_usuario) WHERE u.id_usuario = ".$idX."") or die( 
		mysqli_error($sql2)
	);
...
<html lang="en">
	...
	<head>
		...
		<meta charset="utf-8" />
		<title>MyCompanion | Mudar senha</title>
											...
											<div class="kt-widget kt-widget--user-profile-1">
												...
												<div class="kt-widget__body">
													...
													<div class="kt-widget__items">
														...
														<a href="colaborador/painel/perfil/informacoes-pessoais/" class="kt-widget__item ">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
														...
														<a href="colaborador/painel/perfil/mudar-senha/" class="kt-widget__item kt-widget__item--active">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
									...
									<div class="row">
										<div class="col-xl-12">
											<div class="kt-portlet kt-portlet--height-fluid">
												...
												<form class="kt-form kt-form--label-right" method="post" action="conn/colaborador/mudar.php">
				...
				<div class="kt-demo-panel__item kt-demo-panel__item--active">
					...
					<div class="kt-demo-panel__item-preview">
						...
						<div class="kt-demo-panel__item-preview-overlay">
							<a href="colaborador/painel/" class="btn btn-brand btn-elevate " target="_blank">Preview</a>
						</div>
					</div>
				</div>
