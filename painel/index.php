															...
															<div class="kt-widget2">
																<div class="kt-widget2__item kt-widget2__item--primary">
																	...
																	<?php
																		...
																		$sql = mysqli_query($conn, "SELECT c.descricao, c.nome_encontro FROM combinacoes c INNER JOIN cliente p ON(c.id_cliente = p.id_cliente) INNER JOIN usuario u ON(p.id_usuario = u.id_usuario) WHERE u.id_usuario = '$idX' LIMIT 7") or die( 
