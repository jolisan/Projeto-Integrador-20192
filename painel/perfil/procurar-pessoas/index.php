...
<html lang="en">
	...
	<head>
		...
		<!--end::Base Path -->
		<meta charset="utf-8" />
		<title>MyCompanion | Procurar pessoas</title>
	...
	<body class="kt-app__aside--left kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
		...
		<div class="kt-grid kt-grid--hor kt-grid--root">
			...
			$sql = mysqli_query($conn, "SELECT * FROM colaborador c LEFT JOIN telefone t ON(c.id_usuario = t.id_usuario) LEFT JOIN endereco e ON(c.id_usuario = e.id_usuario) LEFT JOIN usuario u ON(U.id_usuario = c.id_usuario)") or die( 
			...
			while($aux = mysqli_fetch_assoc($sql)) { 
				...
				<!--Begin::Portlet-->
				<form name="form" method="post" action="painel/perfil/procurar-pessoas/curtir.php">
				<div class="kt-portlet kt-portlet--height-fluid">
					...
					<div class="kt-portlet__body">
						...
						<div class="kt-widget kt-widget--user-profile-2">
							...
							<div class="kt-widget__body">
								...
								<div class="kt-widget__item">
									<div class="kt-widget__contact">
										...
										<a class="kt-widget__data">'.$aux["email"].'</a>
									</div>
									<div class="kt-widget__contact">
										<span class="kt-widget__label">Telefone:</span>
										<a class="kt-widget__data">('.$aux["ddd"].') '.$aux["telefone"].'</a>
									</div>
									<div class="kt-widget__contact">
							...
							<input type="hidden" id="" name="id_usuario" value="'.$idX.'"><br>
							<input type="hidden" id="" name="id_colaborador" value="'.$aux["id_colaborador"].'"><br>

							<button id="btaoalterar" class="btn btn-brand btn-bold">Curtir</button>
							</div>
							</form>
						</div>
					...
					<div class="kt-footer  kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" id="kt_footer">
						<div class="kt-container  kt-container--fluid ">
							...
							<div class="kt-footer__menu">
								...
								<a class="kt-footer__menu-link kt-link">Nossa equipe</a>
								<a class="kt-footer__menu-link kt-link">Contato</a>
							</div>
						</div>
					</div>
